...
public:
     ...
     */
    virtual bool Scatter(const ray<float>& r_in, const HitRecord& rec, vec3<float>& attenuation, ray<float>& scattered) const = 0;
...
public:
    ...
    virtual bool Scatter(const ray<float>& r_in, const HitRecord& rec, vec3<float>& attenuation, ray<float>& scattered) const;
